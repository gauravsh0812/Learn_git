...
Lengthlower, Lengthupper, Num = 200, 250, 5000
omml = open("OMML-90K-dataset/OMML_lte250-5K.txt", "w")
olatex = open("OMML-90K-dataset/OLATEX_lte250-5K.txt", "w")
trackfile = open("OMML-90K-dataset/trackfile_lte250.txt", "w")
