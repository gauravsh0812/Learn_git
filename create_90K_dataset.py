...
Lengthlower, Lengthupper, Num = 150, 200, 12000
omml = open("OMML-90K-dataset/OMML_lte200-12K.txt", "w")
olatex = open("OMML-90K-dataset/OLATEX_lte200-12K.txt", "w")
trackfile = open("OMML-90K-dataset/trackfile_lte200.txt", "w")
