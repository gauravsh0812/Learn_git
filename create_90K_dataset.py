...
Lengthlower, Lengthupper, Num = 100, 150, 25000
omml = open("OMML-90K-dataset/OMML_lte150-25K.txt", "w")
olatex = open("OMML-90K-dataset/OLATEX_lte150-25K.txt", "w")
trackfile = open("OMML-90K-dataset/trackfile_lte150.txt", "w")
